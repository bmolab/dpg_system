...
class Stub(SMPLRagdollNode):
    def __init__(self, free, weight=1.0):
        ...
        self.substeps_prop=P(4); self.engine_prop=P('native'); self.motor_strength_prop=P(1.0); self.motor_kp_prop=P(0.6); self.motor_kd_prop=P(0.3); self.root_spring_prop=P(40.0); self.substep_rate_prop=P(240.0); self.locked_stiffness_prop=P(1.0)
