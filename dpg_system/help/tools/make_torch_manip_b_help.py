...
demo = [
    ...
    {'key': 'c2', 'comment': True, 'text': 'everything above 0.5, as a flat tensor',
     'pos': (30, 765)},
    {'key': 'c3', 'comment': True, 'text': 'the shape cannot survive: how many passed',
     'pos': (30, 795)},
    {'key': 'c4', 'comment': True, 'text': 'is not known in advance', 'pos': (30, 825)},
]
links = [('btn', '', 'rnd', '###input'),
...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'each click updates only its own slots',
     'pos': (30, 530)},
    {'key': 'c2', 'comment': True, 'text': 'the rest keeps what it had', 'pos': (30, 560)},
    {'key': 'c3', 'comment': True, 'text': 'click clear on the node to zero it',
     'pos': (30, 590)},
]
