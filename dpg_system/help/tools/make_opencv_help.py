...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'tick to start. Untick to release the',
     'pos': (30, 290)},
    {'key': 'c1', 'comment': True, 'text': 'camera for something else to use',
     'pos': (30, 320)},
    {'key': 'c2', 'comment': True, 'text': "'refresh' opens every camera index in",
     'pos': (30, 360)},
    {'key': 'c3', 'comment': True, 'text': 'turn to find them - it is not instant',
     'pos': (30, 390)},

    {'key': 'inf', 'init': 'info', 'pos': (320, 115), 'w': 260, 'h': 80},
    {'key': 'c4', 'comment': True, 'text': 'height, width, 3 - rows first, and',
     'pos': (320, 210)},
    {'key': 'c5', 'comment': True, 'text': 'already RGB, not OpenCV BGR',
     'pos': (320, 240)},
    ...
    {'key': 'c6', 'comment': True, 'text': 'thin the stream before anything',
     'pos': (30, 530)},
    {'key': 'c7', 'comment': True, 'text': 'expensive downstream', 'pos': (30, 560)},
    ...
    {'key': 'c9', 'comment': True, 'text': 'a still, loaded when triggered - so',
     'pos': (320, 675)},
    {'key': 'c10', 'comment': True, 'text': 'it can walk a directory if something',
     'pos': (320, 705)},
    {'key': 'c11', 'comment': True, 'text': 'else supplies the paths', 'pos': (320, 735)},
]
