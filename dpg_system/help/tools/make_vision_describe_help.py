...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'not required - the node drops frames',
     'pos': (30, 405)},
    {'key': 'c2', 'comment': True, 'text': 'by itself - but there is no point',
     'pos': (30, 435)},
    {'key': 'c3', 'comment': True, 'text': 'handing it work it will only throw away',
     'pos': (30, 465)},
    ...
    {'key': 'c4', 'comment': True, 'text': 'ask a QUESTION - a specific one gives a',
     'pos': (300, 365)},
    {'key': 'c5', 'comment': True, 'text': 'short answer you can act on, where a',
     'pos': (300, 395)},
    {'key': 'c6', 'comment': True, 'text': 'general caption gives you prose',
     'pos': (300, 425)},
    ...
    {'key': 'c7', 'comment': True, 'text': 'the first frame is slow - the model is',
     'pos': (30, 785)},
    {'key': 'c8', 'comment': True, 'text': 'loaded then, and may be downloaded',
     'pos': (30, 815)},
    ...
    {'key': 'c9', 'comment': True, 'text': 'answers arrive when the model finishes,',
     'pos': (400, 765)},
    {'key': 'c10', 'comment': True, 'text': 'not once per frame - drive what comes',
     'pos': (400, 795)},
    {'key': 'c11', 'comment': True, 'text': 'next from the answer, not from the frame',
     'pos': (400, 825)},
]
