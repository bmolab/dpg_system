...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'named once; everything else refers to',
     'pos': (30, 300)},
    {'key': 'c1', 'comment': True, 'text': 'it by name, not by address', 'pos': (30, 330)},
    ...
    {'key': 'c2', 'comment': True, 'text': 'tick use_queue if OSC drives anything',
     'pos': (30, 610)},
    {'key': 'c3', 'comment': True, 'text': 'that draws or touches widgets', 'pos': (30, 640)},
...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'wire unmatched up: it tells you what',
     'pos': (30, 720)},
    {'key': 'c2', 'comment': True, 'text': 'the device is really sending', 'pos': (30, 750)},
...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'prints the whole namespace of the device',
     'pos': (30, 480)},
    {'key': 'c1', 'comment': True, 'text': 'to the console, not into the patch',
     'pos': (30, 510)},
    {'key': 'i1', 'init': 'int', 'pos': (30, 555), 'w': 127, 'h': 42, 'props': INT},
    {'key': 'cu', 'init': 'osc_cue', 'pos': (30, 615), 'w': 260, 'h': 140},
    {'key': 'c2', 'comment': True, 'text': 'the console holds the states;', 'pos': (30, 770)},
    {'key': 'c3', 'comment': True, 'text': 'the patch just says which one', 'pos': (30, 800)},
]
...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'yaw, pitch, roll - pitch and roll are',
     'pos': (30, 370)},
    {'key': 'c2', 'comment': True, 'text': 'dependable; yaw is the magnetic one',
     'pos': (30, 400)},
    ...
    {'key': 'c4', 'comment': True, 'text': 'acceleration needs no heading,',
     'pos': (330, 630)},
    {'key': 'c5', 'comment': True, 'text': 'so no magnetic error', 'pos': (330, 660)},
]
