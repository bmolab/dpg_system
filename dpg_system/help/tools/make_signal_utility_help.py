...
demo = starter() + [
    ...
    {'key': 'c1', 'comment': True, 'text': 'fires above 0.6, releases below 0.3',
     'pos': (30, 380)},
    {'key': 'c2', 'comment': True, 'text': 'the gap between them is the dead zone',
     'pos': (30, 410)},
...
demo = starter() + [
    ...
    {'key': 'c1', 'comment': True, 'text': 'bipolar on: gates both sides of zero',
     'pos': (30, 365)},
    {'key': 'c2', 'comment': True, 'text': 'try squeeze to remove the step',
     'pos': (30, 395)},
...
demo = starter() + [
    ...
    {'key': 'rng', 'init': 'ranger -1.0 1.0 0.0 360.0', 'pos': (30, 255), 'w': 175, 'h': 180,
     'props': {'input_min': -1.0, 'input_max': 1.0,
               ...
               'calibrate': False}},
    {'key': 'c1', 'comment': True, 'text': 'rescaled to degrees, 0 to 360', 'pos': (30, 445)},
    {'key': 'c2', 'comment': True, 'text': 'swap output_min and output_max to invert',
     'pos': (30, 475)},
...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'one value in ten gets through',
     'pos': (30, 515)},
    {'key': 'c2', 'comment': True, 'text': 'drag rate and watch it thin out',
     'pos': (30, 545)},
]
