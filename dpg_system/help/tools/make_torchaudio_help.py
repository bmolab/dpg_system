...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'load a file, then click play\nsame output shape as the live source,\nso they are interchangeable', 'pos': (30, 375)},
