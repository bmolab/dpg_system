...
demo = [
    ...
    {'key': 'c5b', 'comment': True, 'text': 'onset is a continuous 0/1 stream, not a\nbang - a trigger in output bang mode\nturns it into one count per onset',
     'pos': (250, 740)},
