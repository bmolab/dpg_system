...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': "'level to gravity' is the one that saves",
     'pos': (30, 555)},
    {'key': 'c2', 'comment': True, 'text': 'the most time - the floor becomes flat',
     'pos': (30, 585)},
    {'key': 'c3', 'comment': True, 'text': 'whatever angle the camera is bolted at,',
     'pos': (30, 615)},
    {'key': 'c4', 'comment': True, 'text': 'so every height downstream means what',
     'pos': (30, 645)},
    {'key': 'c5', 'comment': True, 'text': 'it says', 'pos': (30, 675)},
    ...
    {'key': 'c7', 'comment': True, 'text': 'pc_crop should be the very NEXT node:',
     'pos': (420, 485)},
    {'key': 'c8', 'comment': True, 'text': 'it throws away most of the room and',
     'pos': (420, 515)},
    {'key': 'c9', 'comment': True, 'text': 'tells the rest of the chain what volume',
     'pos': (420, 545)},
    {'key': 'c10', 'comment': True, 'text': 'it is working in', 'pos': (420, 575)},
    ...
    {'key': 'c12', 'comment': True, 'text': 'IF IT GOES LUMPY mid-rehearsal - frames',
     'pos': (30, 725)},
    {'key': 'c13', 'comment': True, 'text': 'in clumps rather than steadily - that is',
     'pos': (30, 755)},
    {'key': 'c14', 'comment': True, 'text': 'the USB session degrading, not the patch.',
     'pos': (30, 785)},
    {'key': 'c15', 'comment': True, 'text': "Turn on 'auto usb reset on stutter'",
     'pos': (30, 815)},
]
