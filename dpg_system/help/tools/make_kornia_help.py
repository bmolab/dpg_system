...
demo = [
    ...
    {'key': 'c4', 'comment': True, 'text': '3 in, 3 out - same information,',
     'pos': (760, 215)},
    {'key': 'c5', 'comment': True, 'text': 'laid out on different axes',
     'pos': (760, 245)},
]
links = [('btn', '', 'rnd', '###input'),
...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'pure noise: every pixel unlike its',
     'pos': (30, 310)},
    {'key': 'c1', 'comment': True, 'text': 'neighbours - the worst case for an',
     'pos': (30, 340)},
    {'key': 'c2', 'comment': True, 'text': 'edge filter', 'pos': (30, 370)},
    ...
    {'key': 'c3', 'comment': True, 'text': 'blur first - now there are blobs',
     'pos': (30, 580)},
    {'key': 'c4', 'comment': True, 'text': 'big enough to have edges',
     'pos': (30, 610)},
    ...
    {'key': 'c7', 'comment': True, 'text': 'the two sigmas are a band: detail',
     'pos': (770, 540)},
    {'key': 'c8', 'comment': True, 'text': 'between them survives, the rest cancels',
     'pos': (770, 570)},
]
links = [('btn', '', 'rnd', '###input'),
