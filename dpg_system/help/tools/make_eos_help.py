...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'one of these, before anything else -',
     'pos': (30, 315)},
    {'key': 'c1', 'comment': True, 'text': 'the senders find it by name',
     'pos': (30, 345)},
    {'key': 'c2', 'comment': True, 'text': 'set the ip to your desk. 1102 is where',
     'pos': (30, 385)},
    {'key': 'c3', 'comment': True, 'text': 'its replies come back',
     'pos': (30, 415)},
    ...
    {'key': 'c5', 'comment': True, 'text': 'five sliders at channel 7 - each sends',
     'pos': (30, 805)},
    {'key': 'c6', 'comment': True, 'text': 'only when it moves',
     'pos': (30, 835)},
    {'key': 'c7', 'comment': True, 'text': 'lime is the fourth emitter on many LED',
     'pos': (30, 875)},
    {'key': 'c8', 'comment': True, 'text': 'fixtures - it is what makes a good white',
     'pos': (30, 905)},
    ...
    {'key': 'c9', 'comment': True, 'text': 'anything color_source does not cover:',
     'pos': (420, 825)},
    {'key': 'c10', 'comment': True, 'text': 'pan, tilt, zoom, gobo - named as Eos',
     'pos': (420, 855)},
    {'key': 'c11', 'comment': True, 'text': 'spells it, with min/max to suit',
     'pos': (420, 885)},
]
