...
demo = [
    ...
    {'key': 'c2', 'comment': True, 'text': 'plain: every element counts its size',
     'pos': (300, 530)},
    {'key': 'c3', 'comment': True, 'text': 'below an error of 1 the two swap over -',
     'pos': (300, 570)},
    {'key': 'c4', 'comment': True, 'text': 'squaring makes small errors smaller',
     'pos': (300, 600)},
    ...
    {'key': 'c5', 'comment': True, 'text': 'CLICK THE TARGET FIRST, then the scores:',
     'pos': (30, 885)},
    {'key': 'c5b', 'comment': True, 'text': 'target is a cold inlet, and it is the',
     'pos': (30, 915)},
    {'key': 'c5c', 'comment': True, 'text': 'scores arriving that does the work',
     'pos': (30, 945)},
    {'key': 'c6', 'comment': True, 'text': 'change the 0 to a 2 and click again:',
     'pos': (30, 985)},
    {'key': 'c7', 'comment': True, 'text': '0.32 becomes 2.22 - confidently wrong',
     'pos': (30, 1015)},
    {'key': 'c8', 'comment': True, 'text': 'costs far more than being unsure',
     'pos': (30, 1045)},
]
links = [('btn', '', 'rnd', '###input'),
