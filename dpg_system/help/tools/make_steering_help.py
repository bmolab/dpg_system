...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'describe what you want more of, and it',
     'pos': (30, 385)},
    {'key': 'c1', 'comment': True, 'text': 'returns [index, description, votes].',
     'pos': (30, 415)},
    {'key': 'c2', 'comment': True, 'text': 'The index is what gemma wants',
     'pos': (30, 445)},
    {'key': 'c3', 'comment': True, 'text': 'model and layer MUST match gemma - the',
     'pos': (30, 485)},
    {'key': 'c4', 'comment': True, 'text': 'same number in another layer is a',
     'pos': (30, 515)},
    {'key': 'c5', 'comment': True, 'text': 'different concept, and nothing warns you',
     'pos': (30, 545)},
    ...
    {'key': 'c6', 'comment': True, 'text': 'switch intervention_active on and off',
     'pos': (560, 845)},
    {'key': 'c7', 'comment': True, 'text': 'against the same prompt to hear what',
     'pos': (560, 875)},
    {'key': 'c8', 'comment': True, 'text': 'the feature is actually doing',
     'pos': (560, 905)},
    {'key': 'c9', 'comment': True, 'text': 'push GENTLY - a small strength colours',
     'pos': (560, 945)},
    {'key': 'c10', 'comment': True, 'text': 'the writing, a large one makes it',
     'pos': (560, 975)},
    {'key': 'c11', 'comment': True, 'text': 'obsessive and then incoherent',
     'pos': (560, 1005)},

    {'key': 'c12', 'comment': True, 'text': 'prompting asks it to write ABOUT',
     'pos': (30, 600)},
    {'key': 'c13', 'comment': True, 'text': 'something. Steering changes what it is',
     'pos': (30, 630)},
    {'key': 'c14', 'comment': True, 'text': 'thinking about - the subject can stay',
     'pos': (30, 660)},
    {'key': 'c15', 'comment': True, 'text': 'put while the disposition shifts',
     'pos': (30, 690)},
]
