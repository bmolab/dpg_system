...
demo = [
    ...
    {'key': 'tq', 'init': 'smpl_torque', 'pos': (30, 460), 'w': 300, 'h': 300},
    {'key': 'c0', 'comment': True, 'text': 'a pose stream, turned into torque -\nwhich the gangs then read',
     'pos': (30, 775)},

    {'key': 'g1', 'init': 'torque_gang spine_flex', 'pos': (30, 970), 'w': 300, 'h': 300,
     'props': {'stream': 'dynamic', 'normalize': True}},
    {'key': 'c1', 'comment': True, 'text': 'spine_flex on the dynamic stream is the\nACT of bending. Switch stream to gravity\nand it becomes postural load instead',
     'pos': (30, 1285)},

    {'key': 'p1', 'init': 'plot', 'pos': (380, 620), 'w': 300, 'h': 180,
     'props': PLOT(-1.0, 1.0, 200)},
    {'key': 'c4', 'comment': True, 'text': 'net: signed, so opposing efforts cancel',
     'pos': (380, 810)},
    {'key': 'p2', 'init': 'plot', 'pos': (380, 975), 'w': 300, 'h': 180,
     'props': PLOT(0.0, 1.0, 200)},
    {'key': 'c5', 'comment': True, 'text': 'total: nothing cancels', 'pos': (380, 1165)},
    {'key': 'p3', 'init': 'plot', 'pos': (380, 1210), 'w': 300, 'h': 180,
     'props': PLOT(0.0, 1.0, 200)},
    {'key': 'c6', 'comment': True, 'text': 'coherence: 1 is the spine hinging as one\nthing, low is it working against itself',
     'pos': (380, 1400)},

    {'key': 'f1', 'init': 'float', 'pos': (30, 1395), 'w': 127, 'h': 42, 'props': FLT},
    {'key': 'c8', 'comment': True, 'text': 'surprise: unusual against 20M frames',
     'pos': (30, 1445)},

    {'key': 'res', 'init': 'torque_residual', 'pos': (30, 1495), 'w': 280, 'h': 200},
    {'key': 'hm', 'init': 'heat_map', 'pos': (30, 1710), 'w': 208, 'h': 148,
     'props': {'color': 'viridis', 'width': 200, 'height': 100, 'sample count': 24,
               'min y': 0.0, 'max y': 1.0, 'update_mode': 'heat_map',
               'number format': '%.2f'}},
    {'key': 'c9', 'comment': True, 'text': 'what the gangs above did NOT account\nfor - one value per joint',
     'pos': (30, 1870)},
]
