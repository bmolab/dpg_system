...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'quaternions are the measurement',
     'pos': (30, 395)},
    {'key': 'c1', 'comment': True, 'text': 'positions are inferred from them',
     'pos': (30, 425)},
...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'see and set each of the 20 joints',
     'pos': (30, 720)},
    {'key': 'pa', 'init': 'pose_adjust', 'pos': (30, 760), 'w': 260, 'h': 200},
    {'key': 'c1', 'comment': True, 'text': 'child frame changes which frame the',
     'pos': (30, 975)},
    {'key': 'c2', 'comment': True, 'text': 'correction is applied in - it matters',
     'pos': (30, 1005)},
    {'key': 'tp', 'init': 'target_pose', 'pos': (340, 505), 'w': 240, 'h': 140},
    {'key': 'f1', 'init': 'float', 'pos': (340, 660), 'w': 127, 'h': 42, 'props': FLT},
...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'world-space: where each bone points',
     'pos': (30, 610)},
    {'key': 'c1', 'comment': True, 'text': 'measure in global, edit in local',
     'pos': (30, 640)},
