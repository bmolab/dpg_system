...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'tune by eye against the person',
     'pos': (30, 415)},
    {'key': 'c1', 'comment': True, 'text': 'config is what everything else wants',
     'pos': (30, 445)},
...
demo = [
    ...
    {'key': 'c2', 'comment': True, 'text': 'SMPL is Z-up; most else is Y-up',
     'pos': (350, 700)},
    {'key': 'c3', 'comment': True, 'text': 'but do NOT convert before smpl_torque -',
     'pos': (350, 730)},
    {'key': 'c4', 'comment': True, 'text': 'it does this itself', 'pos': (350, 760)},
]
...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'global = drift in the room;',
     'pos': (350, 795)},
    {'key': 'c2', 'comment': True, 'text': 'local = calibration baked into T-pose',
     'pos': (350, 825)},
    {'key': 'fz', 'init': 'floor_zero', 'pos': (30, 815), 'w': 260, 'h': 160},
