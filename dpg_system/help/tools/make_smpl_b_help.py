...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'set axis_permutation to match your input',
     'pos': (30, 975)},
    {'key': 'c1', 'comment': True, 'text': 'it does the up-axis conversion itself',
     'pos': (30, 1005)},
...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'release a limb and it swings from a',
     'pos': (30, 975)},
    {'key': 'c2', 'comment': True, 'text': 'shoulder the performer is still moving',
     'pos': (30, 1005)},
    {'key': 'f1', 'init': 'float', 'pos': (350, 780), 'w': 127, 'h': 42, 'props': FLT},
    {'key': 'c3', 'comment': True, 'text': 'support falling is the body giving way,',
     'pos': (350, 830)},
    {'key': 'c4', 'comment': True, 'text': 'available before it visibly does',
     'pos': (350, 860)},
]
links = [('sh', 'body 1 quaternions', 'ss', 'pose'),
         ('sh', 'body 1 positions', 'ss', 'positions'),
...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'outlets named for the joints', 'pos': (30, 945)},
    {'key': 'c1', 'comment': True, 'text': 'use these when joints are treated',
     'pos': (30, 975)},
    {'key': 'c2', 'comment': True, 'text': 'differently - not for the same thing to all',
     'pos': (30, 1005)},
]
links = [('sh', 'body 1 quaternions', 'ss', 'pose'),
         ('sh', 'body 1 positions', 'ss', 'positions'),
