...
demo = [
    ...
    {'key': 'cq2', 'comment': True, 'text': 'string, not message - a message would',
     'pos': (30, 1330)},
    {'key': 'cq3', 'comment': True, 'text': 'split the phrase into separate words',
     'pos': (30, 1360)},
    {'key': 'wp', 'init': 'weighted_prompt 4', 'pos': (30, 315), 'w': 320, 'h': 280,
     'props': {'width': 200}},
    {'key': 'c0', 'comment': True, 'text': "type 'a dark forest@2' - the box then",
     'pos': (30, 610)},
    {'key': 'c1', 'comment': True, 'text': "rewrites itself as 'a dark forest@2.000'",
     'pos': (30, 640)},
    {'key': 'c2', 'comment': True, 'text': 'a phrase with no @ keeps the slot old',
     'pos': (30, 680)},
    {'key': 'c3', 'comment': True, 'text': 'weight - zero on a fresh one, and zero',
     'pos': (30, 710)},
    {'key': 'c4', 'comment': True, 'text': 'contributes nothing',
     'pos': (30, 740)},
    ...
    {'key': 'c5', 'comment': True, 'text': 'phrase and weight pairs - the weights',
     'pos': (400, 112)},
    {'key': 'c6', 'comment': True, 'text': 'stay numbers, so they can be moved',
     'pos': (400, 142)},
    {'key': 'c7', 'comment': True, 'text': 'smoothly. Negative asks for LESS',
     'pos': (400, 172)},
    ...
    {'key': 'c8', 'comment': True, 'text': 'the same idea as brackets - ((more)),',
     'pos': (400, 555)},
    {'key': 'c9', 'comment': True, 'text': '[[less]]. For anything that only takes',
     'pos': (400, 585)},
    {'key': 'c10', 'comment': True, 'text': 'text, but the weight moves in steps',
     'pos': (400, 615)},
    ...
    {'key': 'cx2', 'comment': True, 'text': 'prefix and context. The phrases come',
     'pos': (400, 795)},
    {'key': 'cx3', 'comment': True, 'text': 'from weighted_prompt above - already',
     'pos': (400, 825)},
    {'key': 'cx4', 'comment': True, 'text': 'phrase-and-weight pairs, which is what',
     'pos': (400, 855)},
    {'key': 'cx5', 'comment': True, 'text': 'this inlet wants',
     'pos': (400, 885)},
    ...
    {'key': 'c11', 'comment': True, 'text': 'prefix, then context, then what is being',
     'pos': (30, 1200)},
    {'key': 'c12', 'comment': True, 'text': 'said, then suffix. Over budget it drops',
     'pos': (30, 1230)},
    {'key': 'c13', 'comment': True, 'text': 'oldest phrases first - never the newest,',
     'pos': (30, 1260)},
    {'key': 'c14', 'comment': True, 'text': 'and never the prefix or suffix',
     'pos': (30, 1290)},
]
