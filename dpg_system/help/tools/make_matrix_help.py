...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'the whole buffer on every input -',
     'pos': (30, 605)},
    {'key': 'c2', 'comment': True, 'text': 'and it comes out in time order, so the',
     'pos': (30, 635)},
    {'key': 'c3', 'comment': True, 'text': 'picture does not lurch when it wraps',
     'pos': (30, 665)},
    ...
    {'key': 'c5', 'comment': True, 'text': 'one sample at a time, on demand -',
     'pos': (400, 465)},
    {'key': 'c6', 'comment': True, 'text': 'which is what makes it a wavetable',
     'pos': (400, 495)},
    ...
    {'key': 'c7', 'comment': True, 'text': 'no index, no asking: always the last',
     'pos': (30, 1085)},
    {'key': 'c8', 'comment': True, 'text': '64 moments, oldest to newest',
     'pos': (30, 1115)},
]
...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'cwt needs a WINDOW - a single sample',
     'pos': (30, 370)},
    {'key': 'c1', 'comment': True, 'text': 'has no time in it to analyse',
     'pos': (30, 400)},
    ...
    {'key': 'c2', 'comment': True, 'text': 'frequency down, time across - an FFT',
     'pos': (30, 780)},
    {'key': 'c3', 'comment': True, 'text': 'would tell you which frequencies but',
     'pos': (30, 810)},
    {'key': 'c4', 'comment': True, 'text': 'not when they happened',
     'pos': (30, 840)},
    ...
    {'key': 'c5', 'comment': True, 'text': 'EXACT matches only - apple hits two',
     'pos': (400, 465)},
    {'key': 'c6', 'comment': True, 'text': 'columns, pear is an empty row',
     'pos': (400, 495)},
    {'key': 'c7', 'comment': True, 'text': 'spacy_confusion looks the same and',
     'pos': (400, 540)},
    {'key': 'c8', 'comment': True, 'text': 'compares meaning instead',
     'pos': (400, 570)},
]
