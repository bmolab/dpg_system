...
demo = starter() + [
    ...
    {'key': 'c2', 'comment': True, 'text': 'tanh: soft limiting, no corner',
     'pos': (30, 725)},
    {'key': 'c3', 'comment': True, 'text': 'swap in any of the others to see its shape',
     'pos': (30, 755)},
]
...
demo = starter() + [
    ...
    {'key': 'c0', 'comment': True, 'text': 'drag negative slope up from zero',
     'pos': (30, 545)},
    {'key': 'c1', 'comment': True, 'text': 'at 0 it is exactly relu', 'pos': (30, 575)},
...
demo = [
    ...
    {'key': 'c2', 'comment': True, 'text': 'scaled up first: nearly a hard choice',
     'pos': (30, 710)},
    {'key': 'c3', 'comment': True, 'text': 'that multiplier is the temperature',
     'pos': (30, 740)},
]
links = [('btn', '', 'rnd', '###input'),
...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'x times log y, with 0 log 0 giving 0',
     'pos': (30, 360)},
    {'key': 'c2', 'comment': True, 'text': 'doing it by hand would give NaN there',
     'pos': (30, 390)},
