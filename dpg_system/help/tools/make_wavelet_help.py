...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'a window to transform - this node takes',
     'pos': (30, 370)},
    {'key': 'c1', 'comment': True, 'text': 'the whole thing at once, unlike ultracwt',
     'pos': (30, 400)},

    {'key': 'cw', 'init': 't.cwt', 'pos': (30, 445), 'w': 320, 'h': 260},
    {'key': 'c2', 'comment': True, 'text': 'sample_scaling is dt - seconds per',
     'pos': (30, 720)},
    {'key': 'c3', 'comment': True, 'text': 'sample. It does not change the picture,',
     'pos': (30, 750)},
    {'key': 'c4', 'comment': True, 'text': 'only what the rows MEAN in Hz - so a',
     'pos': (30, 780)},
    {'key': 'c5', 'comment': True, 'text': 'wrong value is wrong silently',
     'pos': (30, 810)},

    {'key': 'inf', 'init': 'info', 'pos': (400, 445), 'w': 260, 'h': 80},
    {'key': 'c6', 'comment': True, 'text': 'note the leading 1: the answer is',
     'pos': (400, 540)},
    {'key': 'c7', 'comment': True, 'text': 'batch by scales by time, not a plain',
     'pos': (400, 570)},
    {'key': 'c8', 'comment': True, 'text': 'image. Squeeze it before displaying',
     'pos': (400, 600)},
    ...
    {'key': 'c9', 'comment': True, 'text': 'scale_distribution sets the row count:',
     'pos': (400, 905)},
    {'key': 'c10', 'comment': True, 'text': '0.25 -> 33 rows, 0.125 -> 65, 0.0625',
     'pos': (400, 935)},
    {'key': 'c11', 'comment': True, 'text': '-> 129. Halving it doubles the work',
     'pos': (400, 965)},
    {'key': 'c12', 'comment': True, 'text': 'wavelet_constant is w0 - 6 is standard.',
     'pos': (400, 1005)},
    {'key': 'c13', 'comment': True, 'text': 'Higher is sharper in frequency and',
     'pos': (400, 1035)},
    {'key': 'c14', 'comment': True, 'text': 'blurrier in time. You cannot have both',
     'pos': (400, 1065)},
]
links = [('sig', '', 'rb', 'input'),
