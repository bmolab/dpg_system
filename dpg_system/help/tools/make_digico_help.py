...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'move a slider and the console moves.',
     'pos': (30, 500)},
    {'key': 'c1', 'comment': True, 'text': 'Move the fader on the DESK and this',
     'pos': (30, 530)},
    {'key': 'c2', 'comment': True, 'text': 'follows - it sends and receives the',
     'pos': (30, 560)},
    {'key': 'c3', 'comment': True, 'text': 'same addresses', 'pos': (30, 590)},
    ...
    {'key': 'c4', 'comment': True, 'text': 'a whole list into fader 1 sets them all',
     'pos': (400, 112)},
    {'key': 'c5', 'comment': True, 'text': 'in order - how to recall a stored mix',
     'pos': (400, 142)},
    {'key': 'c6', 'comment': True, 'text': 'without twenty separate cords',
     'pos': (400, 172)},
    {'key': 'c6b', 'comment': True, 'text': 'a message node, NOT a string: this inlet',
     'pos': (400, 202)},
    {'key': 'c6c', 'comment': True, 'text': 'wants a list, and string sends one piece',
     'pos': (400, 232)},
    ...
    {'key': 'c8', 'comment': True, 'text': 'DiGiCo cannot be ASKED what it has -',
     'pos': (400, 575)},
    {'key': 'c9', 'comment': True, 'text': "there is no query. Press 'Resend All'",
     'pos': (400, 605)},
    {'key': 'c10', 'comment': True, 'text': 'on the console and it announces',
     'pos': (400, 635)},
    {'key': 'c11', 'comment': True, 'text': 'everything at once - that is how the',
     'pos': (400, 665)},
    {'key': 'c12', 'comment': True, 'text': 'patch learns the current state',
     'pos': (400, 695)},
    {'key': 'c13', 'comment': True, 'text': 'the faders register themselves, so',
     'pos': (400, 740)},
    {'key': 'c14', 'comment': True, 'text': 'oscq_browse can find them and a phone',
     'pos': (400, 770)},
    {'key': 'c15', 'comment': True, 'text': 'can drive them with no extra work',
     'pos': (400, 800)},
]
