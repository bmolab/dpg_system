...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'send this to the second inlet instead:',
     'pos': (30, 450)},
    {'key': 'c2', 'comment': True, 'text': 'about 0.27 - and that is as low as',
     'pos': (30, 480)},
    {'key': 'c3', 'comment': True, 'text': 'unrelated phrases go. 0.4 means nothing.',
     'pos': (30, 510)},
    ...
    {'key': 'c4', 'comment': True, 'text': '300 numbers, however long the phrase',
     'pos': (350, 255)},
    {'key': 'c5', 'comment': True, 'text': 'word order is invisible: it is an average',
     'pos': (350, 285)},
    ...
    {'key': 'c6', 'comment': True, 'text': 'rows apple/pear/engine, columns',
     'pos': (350, 805)},
    {'key': 'c7', 'comment': True, 'text': 'fruit/machine/banana/theory - the two',
     'pos': (350, 835)},
    {'key': 'c8', 'comment': True, 'text': 'fruits light up together, engine alone',
     'pos': (350, 865)},
]
...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'geese -> goose, were -> be, running -> run',
     'pos': (30, 265)},
    {'key': 'c1', 'comment': True, 'text': 'it knows the irregular forms - it has',
     'pos': (30, 295)},
    {'key': 'c2', 'comment': True, 'text': 'parsed the sentence, not chopped endings',
     'pos': (30, 325)},
    ...
    {'key': 'c3', 'comment': True, 'text': 'click these in order, one at a time',
     'pos': (30, 670)},
    {'key': 'c4', 'comment': True, 'text': "'no' steps back to the previous phrase",
     'pos': (30, 700)},
    ...
    {'key': 'c5', 'comment': True, 'text': 'each fragment is folded into the phrase',
     'pos': (450, 725)},
    {'key': 'c6', 'comment': True, 'text': 'built so far, not appended to it',
     'pos': (450, 755)},
    {'key': 'c7', 'comment': True, 'text': 'complexity above the threshold is passed',
     'pos': (450, 800)},
    {'key': 'c8', 'comment': True, 'text': 'through untouched - it works on fragments',
     'pos': (450, 830)},
]
