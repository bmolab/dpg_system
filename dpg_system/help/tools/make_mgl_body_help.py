...
demo = [
    ...
    {'key': 'c2', 'comment': True, 'text': "then the translucent overlay ON TOP -\nyou see the figure and the effort at once\nits ports say 'gl chain' but it is an\nmgl node - the name is a leftover",
     'pos': (400, 1100)},

    {'key': 'c6', 'comment': True, 'text': 'set max torque from the torque you\nactually see. Wrong, and the body reads\nas entirely blue or entirely red',
     'pos': (30, 645)},

    {'key': 'hmap', 'init': 'heat_map', 'pos': (30, 795), 'w': 208, 'h': 148,
