...
demo = [
    ...
    {'key': 'fo', 'init': 'fader_out~ 1 2', 'pos': (30, 915), 'w': 220, 'h': 220},
]
...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'lean on the slider to make it speak',
     'pos': (30, 640)},
    {'key': 'c2', 'comment': True, 'text': 'then sweep lip: it climbs the series',
     'pos': (30, 670)},
...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'set its own velocity and force knobs to zero',
     'pos': (30, 860)},
    {'key': 'c2', 'comment': True, 'text': 'the triad sums, so the arm drives it',
     'pos': (30, 890)},
