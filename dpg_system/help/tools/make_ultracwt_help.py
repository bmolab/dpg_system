...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'the scales - one output row each.',
     'pos': (200, 112)},
    {'key': 'c2', 'comment': True, 'text': 'Powers of two, because interest in a',
     'pos': (200, 142)},
    {'key': 'c3', 'comment': True, 'text': 'signal spreads evenly across octaves',
     'pos': (200, 172)},

    {'key': 'uc', 'init': 't.ultracwt', 'pos': (30, 220), 'w': 320, 'h': 320},
    {'key': 'c4', 'comment': True, 'text': 'attenuation ON, or the slow rows just',
     'pos': (30, 555)},
    {'key': 'c5', 'comment': True, 'text': 'produce bigger numbers than the fast',
     'pos': (30, 585)},
    {'key': 'c6', 'comment': True, 'text': 'ones and the picture is a gradient',
     'pos': (30, 615)},
    ...
    {'key': 'c7', 'comment': True, 'text': 'heat_scroll is the natural destination:',
     'pos': (400, 380)},
    {'key': 'c8', 'comment': True, 'text': 'each frame is a column, history scrolls',
     'pos': (400, 410)},
    {'key': 'c9', 'comment': True, 'text': 'set max y to the range you actually see',
     'pos': (400, 450)},
    {'key': 'c10', 'comment': True, 'text': 'or it reads as blank - about 0.1 here',
     'pos': (400, 480)},

    {'key': 'c11', 'comment': True, 'text': "'unskew' lines the scales up in time.",
     'pos': (30, 665)},
    {'key': 'c12', 'comment': True, 'text': 'A wide wavelet answers about a moment',
     'pos': (30, 695)},
    {'key': 'c13', 'comment': True, 'text': 'further back, so without it an event',
     'pos': (30, 725)},
    {'key': 'c14', 'comment': True, 'text': 'smears diagonally down the picture',
     'pos': (30, 755)},
]
links = [('sig', '', 'uc', 'in 1'),
