...
demo = [
    ...
    {'key': 'rot', 'init': 'mgl_rotate', 'pos': (30, 650), 'w': 220, 'h': 120},
    {'key': 'box', 'init': 'mgl_box', 'pos': (30, 785), 'w': 220, 'h': 200},
    ...
    {'key': 'c2', 'comment': True, 'text': 'the context renders to a texture;',
     'pos': (300, 415)},
    {'key': 'c3', 'comment': True, 'text': 'display puts it in a window', 'pos': (300, 445)},
]
...
demo = [
    ...
    {'key': 'tr1', 'init': 'mgl_translate -1 0 0', 'pos': (30, 610), 'w': 220, 'h': 120},
    {'key': 'box', 'init': 'mgl_box', 'pos': (30, 745), 'w': 220, 'h': 200},
    {'key': 'c0', 'comment': True, 'text': 'the box is moved by the first translate',
     'pos': (30, 960)},
    {'key': 'tr2', 'init': 'mgl_translate 2 0 0', 'pos': (30, 1000), 'w': 220, 'h': 120},
    {'key': 'sph', 'init': 'mgl_sphere', 'pos': (30, 1135), 'w': 220, 'h': 200},
...
demo = [
    ...
    {'key': 'mat', 'init': 'mgl_material', 'pos': (30, 690), 'w': 220, 'h': 180},
    {'key': 'sph', 'init': 'mgl_sphere', 'pos': (30, 885), 'w': 220, 'h': 200},
    {'key': 'c1', 'comment': True, 'text': 'material: it shows its curvature',
     'pos': (30, 1100)},
    {'key': 'col', 'init': 'mgl_color', 'pos': (300, 690), 'w': 220, 'h': 120},
    {'key': 'bx', 'init': 'mgl_box', 'pos': (300, 825), 'w': 220, 'h': 200},
    {'key': 'c2', 'comment': True, 'text': 'colour: flat, no shading', 'pos': (300, 1040)},
