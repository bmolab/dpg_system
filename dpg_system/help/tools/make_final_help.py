...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'review ONE category at a time - the',
     'pos': (30, 600)},
    {'key': 'c1', 'comment': True, 'text': 'judgement is different for each. A break',
     'pos': (30, 630)},
    {'key': 'c2', 'comment': True, 'text': 'is a fact, a spike is a suspicion, a lens',
     'pos': (30, 660)},
    {'key': 'c3', 'comment': True, 'text': 'flag is a statistical lean',
     'pos': (30, 690)},
    {'key': 'c4', 'comment': True, 'text': "walk 'clean sections' too - it is the",
     'pos': (30, 730)},
    {'key': 'c5', 'comment': True, 'text': 'only way to find FALSE NEGATIVES',
     'pos': (30, 760)},
    ...
    {'key': 'c8', 'comment': True, 'text': 'the take player loads it and goes',
     'pos': (420, 475)},
    {'key': 'c9', 'comment': True, 'text': 'straight to the moment in question',
     'pos': (420, 505)},
    {'key': 'c10', 'comment': True, 'text': 'so the loop is: next, look, decide',
     'pos': (420, 545)},
]
...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'place and time are LADDERS - a room is',
     'pos': (30, 925)},
    {'key': 'c2', 'comment': True, 'text': 'in a building is in a city. Saying',
     'pos': (30, 955)},
    {'key': 'c3', 'comment': True, 'text': '"the kitchen" does not throw away',
     'pos': (30, 985)},
    {'key': 'c4', 'comment': True, 'text': '"in winter"', 'pos': (30, 1015)},
    {'key': 'c5', 'comment': True, 'text': 'moving place EJECTS PROPS: what someone',
     'pos': (30, 1055)},
    {'key': 'c6', 'comment': True, 'text': 'was carrying belongs to the scene, and',
     'pos': (30, 1085)},
    {'key': 'c7', 'comment': True, 'text': 'the actors persist but the cup does not',
     'pos': (30, 1115)},
    ...
    {'key': 'c8', 'comment': True, 'text': "'detected' - watch this to see it",
     'pos': (420, 605)},
    {'key': 'c9', 'comment': True, 'text': 'working, and to find out why it is not',
     'pos': (420, 635)},

    {'key': 'pc', 'init': 'prompt_composer', 'pos': (420, 690), 'w': 320, 'h': 340},
    {'key': 'c10', 'comment': True, 'text': "'context out' is shaped for this - the",
     'pos': (420, 1045)},
    {'key': 'c11', 'comment': True, 'text': 'enduring half of the prompt, against the',
     'pos': (420, 1075)},
    {'key': 'c12', 'comment': True, 'text': 'live phrases as the other half',
     'pos': (420, 1105)},
    {'key': 'c13', 'comment': True, 'text': 'the weights do not change what is',
     'pos': (420, 1145)},
    {'key': 'c14', 'comment': True, 'text': 'tracked - they change how strongly each',
     'pos': (420, 1175)},
    {'key': 'c15', 'comment': True, 'text': 'part is asserted downstream',
     'pos': (420, 1205)},
]
