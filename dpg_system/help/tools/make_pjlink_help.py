...
demo = [
    {'key': 'pj', 'init': 'pjlink_projector 10.1.1.141', 'pos': (30, 62),
     'w': 340, 'h': 320},
    {'key': 'c0', 'comment': True, 'text': 'set ip and password in the options,\nTHEN connect. Watch status - an\nunconnected projector just ignores you',
     'pos': (30, 400)},
    ...
    {'key': 'c6', 'comment': True, 'text': 'a raw query, sent as typed - this is\nhow you ask about lamp hours, errors,\nor which model it actually is\nleave POWER alone in performance - it\ntakes tens of seconds and ignores you\nentirely while it cools',
     'pos': (30, 725)},
]
