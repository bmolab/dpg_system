...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'one button per target, from the config',
     'pos': (30, 335)},
    {'key': 'c1', 'comment': True, 'text': 'file. The live one is marked.',
     'pos': (30, 365)},
    {'key': 'c2', 'comment': True, 'text': 'EDIT THE CONFIG and you must re-create',
     'pos': (30, 405)},
    {'key': 'c3', 'comment': True, 'text': 'the node - its shape is fixed when it is',
     'pos': (30, 435)},
    {'key': 'c4', 'comment': True, 'text': 'made, so reopening the patch is not enough',
     'pos': (30, 465)},
    ...
    {'key': 'c5', 'comment': True, 'text': 'select takes a name or a number,',
     'pos': (400, 112)},
    {'key': 'c6', 'comment': True, 'text': 'counting from 1', 'pos': (400, 142)},
    ...
    {'key': 'c7', 'comment': True, 'text': 'what is live NOW - it reports, rather',
     'pos': (400, 240)},
    {'key': 'c8', 'comment': True, 'text': 'than echoing what you asked for, so a',
     'pos': (400, 270)},
    {'key': 'c9', 'comment': True, 'text': 'button press by hand shows up here too',
     'pos': (400, 300)},

    {'key': 'c10', 'comment': True, 'text': 'a switch takes about a second - measured',
     'pos': (400, 345)},
    {'key': 'c11', 'comment': True, 'text': '0.8, 0.9, 3.5 and 7.7s over four. The',
     'pos': (400, 375)},
    {'key': 'c12', 'comment': True, 'text': 'long ones are the receiver reporting',
     'pos': (400, 405)},
    {'key': 'c13', 'comment': True, 'text': 'itself paired, not the picture arriving',
     'pos': (400, 435)},

    {'key': 'c14', 'comment': True, 'text': 'video and USB route SEPARATELY. Picture',
     'pos': (400, 480)},
    {'key': 'c15', 'comment': True, 'text': 'changed but mouse did not? That is the',
     'pos': (400, 510)},
    {'key': 'c16', 'comment': True, 'text': 'USB pairing, not the video',
     'pos': (400, 540)},
]
