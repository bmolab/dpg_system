...
demo = [
    ...
    {'key': 'c1', 'comment': True, 'text': 'no account, no key - it asks the same',
     'pos': (30, 435)},
    {'key': 'c2', 'comment': True, 'text': 'page a browser would. About 0.7s',
     'pos': (30, 465)},
    ...
    {'key': 'c3', 'comment': True, 'text': 'the answer arrives LATER, not on the',
     'pos': (400, 375)},
    {'key': 'c4', 'comment': True, 'text': 'same frame it went out - drive what',
     'pos': (400, 405)},
    {'key': 'c5', 'comment': True, 'text': 'comes next from this, not from the send',
     'pos': (400, 435)},

    {'key': 'c6', 'comment': True, 'text': 'leave use queue ON: with it off, a',
     'pos': (30, 510)},
    {'key': 'c7', 'comment': True, 'text': 'request arriving while another is in',
     'pos': (30, 540)},
    {'key': 'c8', 'comment': True, 'text': 'flight is simply lost',
     'pos': (30, 570)},

    {'key': 'c9', 'comment': True, 'text': 'translate_api is the paid, supported',
     'pos': (30, 615)},
    {'key': 'c10', 'comment': True, 'text': 'route. It only appears if the Google',
     'pos': (30, 645)},
    {'key': 'c11', 'comment': True, 'text': 'Cloud SDK is installed - and then needs',
     'pos': (30, 675)},
    {'key': 'c12', 'comment': True, 'text': 'GOOGLE_APPLICATION_CREDENTIALS set',
     'pos': (30, 705)},
    {'key': 'c13', 'comment': True, 'text': 'BOTH send your text to Google. Nothing',
     'pos': (30, 750)},
    {'key': 'c14', 'comment': True, 'text': 'private should go through either',
     'pos': (30, 780)},
]
