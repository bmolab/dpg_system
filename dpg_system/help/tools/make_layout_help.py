...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'leading is line spacing - the setting',
     'pos': (30, 475)},
    {'key': 'c1', 'comment': True, 'text': 'that does most for how it feels',
     'pos': (30, 505)},
    {'key': 'c2', 'comment': True, 'text': 'empty font path falls back to a bundled',
     'pos': (30, 545)},
    {'key': 'c3', 'comment': True, 'text': 'one - a missing file never stops it',
     'pos': (30, 575)},

    {'key': 'inf', 'init': 'info', 'pos': (400, 120), 'w': 260, 'h': 80},
    {'key': 'c4', 'comment': True, 'text': 'the layout is an IMAGE - send it to a',
     'pos': (400, 215)},
    {'key': 'c5', 'comment': True, 'text': 'texture, a projector, anything that',
     'pos': (400, 245)},
    {'key': 'c6', 'comment': True, 'text': 'takes a picture', 'pos': (400, 275)},
    ...
    {'key': 'c7', 'comment': True, 'text': "layout_out does not send TEXT - it sends",
     'pos': (420, 905)},
    {'key': 'c8', 'comment': True, 'text': 'commands, and this node understands them',
     'pos': (420, 935)},
    {'key': 'c9', 'comment': True, 'text': 'so the screen can show which alternatives',
     'pos': (420, 975)},
    {'key': 'c10', 'comment': True, 'text': 'the model weighed, not just what it said',
     'pos': (420, 1005)},
    {'key': 'c11', 'comment': True, 'text': 'colour_mode paints each token by how',
     'pos': (420, 1045)},
    {'key': 'c12', 'comment': True, 'text': 'sure the model was as it wrote it',
     'pos': (420, 1075)},
    {'key': 'c13', 'comment': True, 'text': 'new text stays on active_line, and the',
     'pos': (30, 1145)},
    {'key': 'c14', 'comment': True, 'text': 'rest scrolls up past it - the writing',
     'pos': (30, 1175)},
    {'key': 'c15', 'comment': True, 'text': 'happens at a fixed height on screen',
     'pos': (30, 1205)},
]
