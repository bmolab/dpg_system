...
demo = [
    ...
    {'key': 'c0', 'comment': True, 'text': 'pan and tilt are SPEEDS. Set one and the',
     'pos': (30, 560)},
    {'key': 'c1', 'comment': True, 'text': 'camera keeps moving until you set it',
     'pos': (30, 590)},
    {'key': 'c2', 'comment': True, 'text': 'back to zero or press stop',
     'pos': (30, 620)},
    ...
    {'key': 'c3', 'comment': True, 'text': 'NOTHING HERE IS CONNECTED, on purpose:',
     'pos': (450, 155)},
    {'key': 'c4', 'comment': True, 'text': 'this node sends as soon as a value',
     'pos': (450, 185)},
    {'key': 'c5', 'comment': True, 'text': 'arrives, and a help file should not',
     'pos': (450, 215)},
    {'key': 'c5b', 'comment': True, 'text': 'start moving your camera. Set the ip,',
     'pos': (450, 245)},
    {'key': 'c5c', 'comment': True, 'text': 'then connect these yourself',
     'pos': (450, 275)},
    {'key': 'c5d', 'comment': True, 'text': 'sine -> pan sweeps back and forth, and',
     'pos': (450, 315)},
    {'key': 'c5e', 'comment': True, 'text': 'works because it returns to zero',
     'pos': (450, 345)},
    ...
    {'key': 'c7', 'comment': True, 'text': 'presets are how to work: frame the shots',
     'pos': (450, 655)},
    {'key': 'c8', 'comment': True, 'text': 'by hand once, store them, then the patch',
     'pos': (450, 685)},
    {'key': 'c9', 'comment': True, 'text': 'only ever recalls numbers',
     'pos': (450, 715)},

    {'key': 'c10', 'comment': True, 'text': 'IF THE CAMERA STOPS RESPONDING with no',
     'pos': (450, 655)},
    {'key': 'c11', 'comment': True, 'text': 'error at all, press reset_sequence -',
     'pos': (450, 685)},
    {'key': 'c12', 'comment': True, 'text': 'the packet count has got out of step,',
     'pos': (450, 715)},
    {'key': 'c13', 'comment': True, 'text': 'and it ignores you silently until reset',
     'pos': (450, 745)},
]
