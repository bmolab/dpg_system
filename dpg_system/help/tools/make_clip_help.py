...
demo = [
    ...
    {'key': 'c2', 'comment': True, 'text': 'the vector itself - the meaning is in',
     'pos': (320, 495)},
    {'key': 'c3', 'comment': True, 'text': 'which way it points, not in any one',
     'pos': (320, 525)},
    {'key': 'c4', 'comment': True, 'text': 'of these numbers',
     'pos': (320, 555)},
    ...
    {'key': 'c5', 'comment': True, 'text': 'try both phrases, and something quite',
     'pos': (30, 745)},
    {'key': 'c6', 'comment': True, 'text': 'unlike them: the length hardly moves.',
     'pos': (30, 775)},
    {'key': 'c7', 'comment': True, 'text': 'Measured range across unrelated phrases',
     'pos': (30, 805)},
    {'key': 'c8', 'comment': True, 'text': 'is only 23.4 to 24.5 - it is not a',
     'pos': (30, 835)},
    {'key': 'c9', 'comment': True, 'text': 'measure of meaning',
     'pos': (30, 865)},
]
